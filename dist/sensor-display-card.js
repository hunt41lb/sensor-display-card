      ...
      >
        ...
        ${u?I`
              <div class="icon-container" style="${h}">
                <ha-icon .icon=${l} style="${d}"></ha-icon>
              </div>
        ...
        <!-- Motion Sensor -->
        <div class="motion">
          ${r?I`<ha-icon class="motion-active" icon="mdi:motion-sensor"></ha-icon>`:V}
        </div>
      </ha-card>
